...
A fork of https://github.com/hzeller/rpi-rgb-led-matrix.

The main files to be concerned with are poll_server.py and adshirtise.cc. Everything else is there because we are too lazy.
